<%-- 
    Document   : teamdemo
    Created on : 2015-12-22, 17:23:12
    Author     : rain
--%>
<%@page import="java.util.List"%>
<%@page import="com.ct855.entity.TeamBean"%>
                    ...
                    <table class="table table-striped table-bordered responsive">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${list}" var="item" varStatus="status">
                                <tr>
                                    <td class="center">用户编号：${item.teamID}</td>
                                    <td class="center">用户名：${item.key}</td>
                                    <td class="center">用户密码：${item.name}</td>
                                    <td class="center">
                                        <span class="label-warning label label-default">Activity</span>
                                    </td>
                                    <td class="center">
